...
public class OrderControllerTest extends BaseApiTest{
    ...
    @Autowired
    private org.acme.work_order.workorder.internal.OrderServiceImpl woService;
    ...
    void createWorkOrder_success() throws Exception {
        // Arrange
        org.acme.work_order.workorder.OrderDTO woDTO = org.acme.work_order.workorder.OrderDTO.builder()
                .woNumber("testNumber")
                .jobTypeCode("type1")
        ...
        org.acme.work_order.workorder.internal.Order wo = woDAO.findByWoNumber("testNumber");
        // Assert
