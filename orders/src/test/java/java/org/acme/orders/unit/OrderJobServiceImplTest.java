...
public class OrderJobServiceImplTest {
    ...
    @Mock
    private org.acme.work_order.workorderjob.internal.OrderJobMapper woJobMapperMock;

    @Mock
    private org.acme.work_order.workorder.internal.OrderDAO woDAOMock;

    @InjectMocks
    private org.acme.work_order.workorderjob.internal.OrderJobServiceImpl service;
