...
public final class TestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.acme.rules.grpc.TestGo,
      org.acme.rules.grpc.TestBack> getTestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "test",
      requestType = org.acme.rules.grpc.TestGo.class,
      responseType = org.acme.rules.grpc.TestBack.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.acme.rules.grpc.TestGo,
      org.acme.rules.grpc.TestBack> getTestMethod() {
    io.grpc.MethodDescriptor<org.acme.rules.grpc.TestGo, org.acme.rules.grpc.TestBack> getTestMethod;
    if ((getTestMethod = TestServiceGrpc.getTestMethod) == null) {
      synchronized (TestServiceGrpc.class) {
        if ((getTestMethod = TestServiceGrpc.getTestMethod) == null) {
          TestServiceGrpc.getTestMethod = getTestMethod =
              io.grpc.MethodDescriptor.<org.acme.rules.grpc.TestGo, org.acme.rules.grpc.TestBack>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "test"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.acme.rules.grpc.TestGo.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.acme.rules.grpc.TestBack.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void test(org.acme.rules.grpc.TestGo request,
        io.grpc.stub.StreamObserver<org.acme.rules.grpc.TestBack> responseObserver) {
  ...
  public static final class TestServiceStub
    ...
    /**
     */
    public void test(org.acme.rules.grpc.TestGo request,
        io.grpc.stub.StreamObserver<org.acme.rules.grpc.TestBack> responseObserver) {
  ...
  public static final class TestServiceBlockingStub
    ...
    /**
     */
    public org.acme.rules.grpc.TestBack test(org.acme.rules.grpc.TestGo request) {
  ...
  public static final class TestServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.acme.rules.grpc.TestBack> test(
        org.acme.rules.grpc.TestGo request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEST:
          serviceImpl.test((org.acme.rules.grpc.TestGo) request,
              (io.grpc.stub.StreamObserver<org.acme.rules.grpc.TestBack>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.acme.rules.grpc.TestGo,
              org.acme.rules.grpc.TestBack>(
  ...
  private static abstract class TestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.acme.rules.grpc.TestConnection.getDescriptor();
    }
